  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        <h2 className="text-2xl font-bold text-ocean-900 mb-6 text-center">Giriş Yap</h2>
        {error && (
        ...
        <p className="mt-6 text-center text-sm text-gray-600">
          Hesabın yok mu?{" "}
          <Link to="/register" className="text-ocean-600 hover:underline font-medium">Kayıt ol</Link>
        </p>
      </div>
    </div>
  );
